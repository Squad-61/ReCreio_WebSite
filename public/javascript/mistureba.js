...
function tip(){
  ...
  function gamsOver(){
    ...
    function Speak2(){
      let txt = 'Mistureba é um jogo onde você tem de acertar qual é a palavra embaralhada. Caso seja uma palavra mais difícil é possível pedir uma ajuda clicando no botão de lâmpada, assim ajudando na jogatina. Eaí já descobriu qual é a palavra ?'
